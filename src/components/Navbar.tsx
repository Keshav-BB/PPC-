      ...
      <div className="bg-slate-900 text-slate-300 text-xs py-2 px-4 border-b border-slate-800">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2">
          ...
          <div className="flex items-center gap-4 text-[11px] sm:text-xs whitespace-nowrap shrink-0">
            ...
            <Link
              href="/admin/billing"
              className="hidden lg:flex items-center gap-1.5 text-purple-300 hover:text-white transition-colors font-bold whitespace-nowrap shrink-0"
              title="Open Sales & Billing Studio to create Quotes and Invoices"
            >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <div className="hidden xl:flex items-center gap-2.5 shrink-0 ml-2">
            <Link
              href="/admin/billing"
              className="text-xs font-bold text-slate-700 hover:text-purple-900 bg-slate-50 hover:bg-purple-50 px-3 py-2 rounded-xl border border-slate-200 hover:border-purple-300 transition-all flex items-center gap-1.5 whitespace-nowrap shrink-0"
              title="Open Sales & Billing Studio to create Quotations and Invoices"
            >
              <Receipt className="w-3.5 h-3.5 text-purple-700 shrink-0" />
              <span>Quote & Invoice</span>
            </Link>
            ...
            <div className="border-t border-slate-100 pt-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <Link
                  ...
                  className="p-2.5 rounded-xl bg-purple-50 border border-purple-200 text-purple-950 font-bold text-xs flex items-center gap-2 hover:bg-purple-100"
                >
                  <Receipt className="w-4 h-4 text-purple-700 shrink-0" />
                  <span>+ New Quote</span>
                </Link>
                <Link
                  href="/admin/billing?tab=invoices&action=new-invoice"
                  onClick={() => setMobileMenuOpen(false)}
                  className="p-2.5 rounded-xl bg-rose-50 border border-rose-200 text-rose-950 font-bold text-xs flex items-center gap-2 hover:bg-rose-100"
                >
